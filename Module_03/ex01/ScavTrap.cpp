...
/*   Updated: 2021/03/12 13:13:43 by kbatwoma         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		ScavTrap::rangedAttack(std::string const & target)
{
	...
	{
		std::cout << COL_AQUAMARINE << "< SC4V-TP " << _name << " trying to attack " << target << ", but its energy is running out >" << std::endl;
	...
	else
	{
		...
		std::cout << COL_AQUAMARINE << "< SC4V-TP " << _name << " attacks " << target << " at range, causing " << _ranged_attack_damage << " points of damage! >" << std::endl;
		std::cout << "|| " << _name << " | Energy points: " << _energy_points << COL_END << std::endl;
...
int		ScavTrap::meleeAttack(std::string const & target)
{
	...
	else
	{
		...
		std::cout << COL_AQUAMARINE << "< SC4V-TP " << _name << " attacks " << target << " in melee , causing " << _melee_attack_damage << " points of damage! >" << std::endl;
		std::cout << "|| " << _name << " | Energy points: " << _energy_points << COL_END << std::endl;
...
void	ScavTrap::takeDamage(unsigned int amount)
{
	...
	std::cout << COL_AQUAMARINE << "|| " << _name << " | Armor damage reduction: " << _armor_damage_reduction << std::endl;	
...
void	ScavTrap::beRepaired(unsigned int amount)
{
	...
	std::cout << COL_AQUAMARINE << "< SC4V-TP " << _name << " was repaired by " << amount << " hit points" << std::endl;
